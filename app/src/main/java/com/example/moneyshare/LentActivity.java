...
public class  LentActivity extends AppCompatActivity implements TabLayoutMediator.TabConfigurationStrategy {
    ...
    public void setViewPagerAdapter() {
        ...
        fragmentList.add(new LendOrderPlacedFragment());
        fragmentList.add(new LendOrderExecutedFragment());
